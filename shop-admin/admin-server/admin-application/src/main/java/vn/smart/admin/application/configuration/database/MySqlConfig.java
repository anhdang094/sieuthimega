package vn.smart.admin.application.configuration.database;
...
@EnableJpaRepositories(basePackages = "vn.smart.admin.domain.repository",
...
public class MySqlConfig {
  ...
  public LocalContainerEntityManagerFactoryBean shopEntityManager() {
    ...
    em.setPackagesToScan(new String[]{"vn.smart.admin.domain.model"});
